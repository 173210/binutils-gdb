...
eval $COMBRELOCCAT <<EOF
  ...
  .rel.${RODATA_NAME}.sceModuleInfo ${RELOCATING-0} : { *(.rel.${RODATA_NAME}.sceModuleInfo) }
  .rel.${RODATA_NAME}.sceResident   ${RELOCATING-0} : { *(.rel.${RODATA_NAME}.sceResident) }
  .rel.${RODATA_NAME}.sceNid        ${RELOCATING-0} : { *(.rel.${RODATA_NAME}.sceNid) }
  .rel.${RODATA_NAME}.sceVstub        ${RELOCATING-0} : { *(.rel.${RODATA_NAME}.sceVstub) *(SORT(.rel.${RODATA_NAME}.sceVstub.*)) }
...
cat <<EOF
  ...
  .${RODATA_NAME}.sceModuleInfo  ${RELOCATING-0} : { *(.${RODATA_NAME}.sceModuleInfo) }
  .${RODATA_NAME}.sceResident    ${RELOCATING-0} : { *(.${RODATA_NAME}.sceResident) }
  .${RODATA_NAME}.sceNid         ${RELOCATING-0} : { *(.${RODATA_NAME}.sceNid) }
  .${RODATA_NAME}.sceVstub       ${RELOCATING-0} : { *(.${RODATA_NAME}.sceVstub) *(SORT(.${RODATA_NAME}.sceVstub.*)) }
